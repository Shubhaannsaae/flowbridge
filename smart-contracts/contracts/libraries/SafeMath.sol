 ...
 * Note: OpenZeppelin's SafeMath is not needed for Solidity 0.8+, but keeping for consistency
 */
library SafeMath {
    /**
    ...
    /**
     * @dev Returns the remainder of dividing two unsigned integers, reverting with custom message
     */
