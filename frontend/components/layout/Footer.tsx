// FlowBridge Frontend - Footer Component
...
const Footer: React.FC<FooterProps> = ({ className }) => {
  ...
  const footerLinks = {
    ...
    resources: [
      { name: 'Documentation', href: EXTERNAL_LINKS.DOCS },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">FlowBridge</span>
            </div>
        ...
        <div className="border-t mt-12 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-sm text-muted-foreground">
              © {currentYear} FlowBridge. All rights reserved.
            </div>
          ...
          <div className="mt-6 p-4 bg-muted/50 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-xs text-muted-foreground">
                ...
                <p>
                  FlowBridge is a decentralized application. Always verify transactions before confirming. 
                  Never share your private keys or seed phrases. Use official links only and be aware of potential smart contract risks.
                </p>
              </div>
            </div>
          </div>
